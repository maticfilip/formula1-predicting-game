                ...
                <div className="card p-4" style={{width: '650px', backgroundColor: '#141414', border: '1px solid #222222', borderRadius: '8px'}}>
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                <input type="text" className="form-control form-input" placeholder="Username" />
                            </div>
                            <div className="mb-3">
                            ...
                            <button className="btn-primary w-100 mb-3">Login</button>
                            <Link to="/register" className="forgot">Don't have an account?</Link>
                        </div>
